...
namespace MMD
{
	public class VMDConverter
	{
			...
			out AnimationCurve curve_x, out AnimationCurve curve_y, out AnimationCurve curve_z)
		{
			...
			{
				AnimationUtility.SetKeyLeftTangentMode(curve_x, i, AnimationUtility.TangentMode.Auto);
				AnimationUtility.SetKeyRightTangentMode(curve_x, i, AnimationUtility.TangentMode.Auto);
			}
			for (int i = 0; i < curve_y.keys.Length; i++)
			{
				AnimationUtility.SetKeyLeftTangentMode(curve_y, i, AnimationUtility.TangentMode.Auto);
				AnimationUtility.SetKeyRightTangentMode(curve_y, i, AnimationUtility.TangentMode.Auto);
			}
			for (int i = 0; i < curve_z.keys.Length; i++)
			{
				AnimationUtility.SetKeyLeftTangentMode(curve_z, i, AnimationUtility.TangentMode.Auto);
				AnimationUtility.SetKeyRightTangentMode(curve_z, i, AnimationUtility.TangentMode.Auto);
			}
		}
        ...
        AnimationCurve ToAnimationCurveForLocation(FloatKeyframe[] custom_keys)
		{
			...
			{
				AnimationUtility.SetKeyLeftTangentMode(retCurve, i, AnimationUtility.TangentMode.Auto);
				AnimationUtility.SetKeyRightTangentMode(retCurve, i, AnimationUtility.TangentMode.Auto);
			}
